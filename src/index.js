...
if (process.env.JBL_DISCORD_TOKEN) {
  jblClient = new Client({
    intents: [
      ...
      GatewayIntentBits.GatewayIntentBits || GatewayIntentBits.GuildVoiceStates,
...
client.on('interactionCreate', async interaction => {
  ...
  try {
    ...
    await handleDiscordError(interaction, error, `slash:${interaction.commandName}`);
  }
});

// =========================================================================
// TRATAMENTO DE ERROS GLOBAIS (Decisão: Logar e manter processo rodando)
// =========================================================================
